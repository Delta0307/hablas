...
extern "C" __global__ __aicore__ void hablas_hgemm_batched_b1024_kernel(hablasOperation_t transA,
                                                                  ...
                                                                  int64_t batch_count)
#else
extern "C" __global__ __aicore__ void hablas_hgemm_batched_b1024_kernel(__gm__ int64_t *matrixA1,
